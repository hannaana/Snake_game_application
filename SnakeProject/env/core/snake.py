...
class Snake:
    ...
    def step(self, action):
        ...
        if action != self.current_direction_index and list(DIRECTIONS[action]) != list(-DIRECTIONS[self.current_direction_index]):
        ...
        # Check new head
        # new_head = tuple(list(self.blocks[0]) + list((DIRECTIONS[self.current_direction_index])))
